...
public class EGLConfigSimpleChooser implements EGLConfigChooser {
    ...
    private final static Comparator<EGLConfig> CONFIG_COMPARATOR = (o1, o2) -> {
        ...
        if (o1.isConformantGL10() == false && o2.isConformantGL10() == true) {
            return 1;
        }
        if (o1.isConformantGL20() == false && o2.isConformantGL20() == true) {
            return 1;
        }
        if (o1.isConformantGL30() == false && o2.isConformantGL30() == true) {
            return 1;
        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EGLConfigSimpleChooser)) return false;
        EGLConfigSimpleChooser that = (EGLConfigSimpleChooser) o;
        return alphaSize == that.alphaSize && blueSize == that.blueSize && greenSize == that.greenSize && redSize == that.redSize && depthSize == that.depthSize && stencilSize == that.stencilSize && samples == that.samples && sampleBuffers == that.sampleBuffers && windowSurface == that.windowSurface && pbufferSurface == that.pbufferSurface && Objects.equals(renderGL10, that.renderGL10) && Objects.equals(renderGL20, that.renderGL20) && Objects.equals(renderGL30, that.renderGL30) && Objects.equals(recordable, that.recordable);
    }

    @Override
    public int hashCode() {
        return Objects.hash(alphaSize, blueSize, greenSize, redSize, depthSize, stencilSize, samples, sampleBuffers, windowSurface, pbufferSurface, renderGL10, renderGL20, renderGL30, recordable);
    }
